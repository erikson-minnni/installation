...
class IMX500Detector:
    ...
    def __init__(self, model_path):
        ...
        if self.intrinsics.labels is None:
            with open("/home/pi/food_scale/my_modelrpk/classes.txt", "r") as f:
    ...
    def capture_image(self, directory = "/home/pi/food_scale/images/"):

        timestamp = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
        filename = os.path.join(directory, f"detection_{timestamp}.jpg")
    ...
    def capture_and_detect(self, directory="/home/pi/food_scale/images/"):


        """Captures a frame, processes detections, and cleans up the image."""
...
# Add this inside your IMX500Detector class in ai_camera2.py
    def get_detected_names(self):
        """Returns a list of names of detected objects."""
        detections = self.get_detections()
        labels = self.get_labels()
        # Return a list of names
        return [labels[int(d.category)] for d in detections]
